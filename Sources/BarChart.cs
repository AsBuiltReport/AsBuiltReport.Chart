            ...
            if (values.Length == labels.Length)
            {
                ...
                switch (AreaOrientation)
                {
                    case Orientations.Horizontal:
                        bottomLabelText = LabelYAxis;
                        break;
                    case Orientations.Vertical:
                        bottomLabelText = LabelXAxis;
                        break;
                }
                myPlot.Axes.Bottom.Label.Text = bottomLabelText;
                ...
                {
                    case Orientations.Horizontal:
                        leftLabelText = LabelXAxis;
                        break;
                    case Orientations.Vertical:
                        leftLabelText = LabelYAxis;
                        break;
                }
                myPlot.Axes.Left.Label.Text = leftLabelText;
